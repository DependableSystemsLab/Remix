...
def generate_csv(y_test, predictions_A):
    ...
    file_name = "./remix_results/boost-" + str(ens_size)  + "_" + modelA_name + "_" + dataset + "_" +  final_fault + ".csv"
    df.to_csv(file_name)
...
def main(argv):
    ...
    boosted_ann = AdaBoostClassifier(base_estimator=modelA_estimator, n_estimators=ens_size)
